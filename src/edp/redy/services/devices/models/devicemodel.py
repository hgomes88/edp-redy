...
class ClimatizationDeviceTypesMap:
    """Climatization device types map."""
    ...
    map: Dict[IDeviceType, TypeMap] = {
        ...
        ClimatizationDeviceType.AirConditioning: TypeMap(
            order=3, groups=[DeviceGroup.Hvac], nonGroups=[], properties={}
        ),
    }


class SensorsDeviceTypesMap:
    """Sensors device types map."""

    map: Dict[IDeviceType, TypeMap] = {
        SensorsDeviceType.DoorWindow: TypeMap(
            order=1, groups=[DeviceGroup.DoorWindow], nonGroups=[], properties={}
        ),
        SensorsDeviceType.Flood: TypeMap(
            order=2, groups=[DeviceGroup.Water], nonGroups=[], properties={}
        ),
        SensorsDeviceType.Smoke: TypeMap(
            order=3, groups=[DeviceGroup.Fire], nonGroups=[], subtypes={}
        ),
        SensorsDeviceType.Motion: TypeMap(
            order=4, groups=[DeviceGroup.Motion], nonGroups=[], subtypes={}
        ),
    }
...
class DeviceTypeMap:
    ...
    map: Dict[DeviceType, TypeMap] = {
        DeviceType.Consumption: TypeMap(
            ...
            nonGroups=[DeviceGroup.SmartEnergyMeter, DeviceGroup.ProductionMeter],
            properties={},
        ),
        DeviceType.Generation: TypeMap(
            order=2, groups=[DeviceGroup.ProductionMeter], nonGroups=[], properties={}
        ),
